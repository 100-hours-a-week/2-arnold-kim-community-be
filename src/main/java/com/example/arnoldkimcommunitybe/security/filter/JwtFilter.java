package com.example.arnoldkimcommunitybe.security.filter;

import com.example.arnoldkimcommunitybe.security.JwtUtil;
import com.example.arnoldkimcommunitybe.security.Session;
import com.example.arnoldkimcommunitybe.util.CONSTANT;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    private boolean shouldSkip(HttpServletRequest request) {
        List<String> skipURI = Arrays.asList("/login", "/auth/.*", "/users/signup", "/images/.*", "/users/info");
